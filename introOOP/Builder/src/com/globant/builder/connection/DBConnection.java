 ...
 *
 *  It contains a {@link java.sql.Connection} type object.
 *
 *  It uses {@link com.globant.builder.connection.items.ConnectionItem} type objects
 *  to authenticate.
 *
 * @author bohledevs
 * @version 1.1
...
import com.globant.builder.connection.items.ConnectionItem;
import com.globant.builder.connection.items.Password;
import com.globant.builder.connection.items.URL;
import com.globant.builder.connection.items.Username;
